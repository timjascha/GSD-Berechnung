...
gsd_c = PushButton(app, text="Flughöhe berechnen", command=calcgsd, grid=[2,2])
resw_t = Text(app, text="Auflösung breit", grid=[0,3])
resw = TextBox(app, text="Auflösung breit", grid=[1,3])
resh_t = Text(app, text="Auflösung hoch", grid=[2,3])
resh = TextBox(app, text="Auflösung hoch", grid=[3,3])
sensw_t = Text(app, text="Sensorbreite", grid=[0,4])
sensw = TextBox(app, text="Sensorbreite", grid=[1,4])
sensh_t = Text(app, text="Sensorhöhe", grid=[2,4])
sensh= TextBox(app,text="Sensorhöhe", grid=[3,4])
fole_t = Text(app, text="Brennweite", grid=[0,5])
fole = TextBox(app, text="Brennweite", grid=[1,5])
psize_t = Text(app, text="Pixelgröße", grid=[0,6])
psize = TextBox(app, text="Pixelgröße", grid=[1,6])
...
areaw_v = TextBox(app, text="Breite des Bereichs in mm", grid=[1,8])
areal_t = Text(app, text="Länge des Bereichs in mm", grid=[0,9])
areal_v = TextBox(app, text="Länge des Bereichs in mm", grid=[1,9])
